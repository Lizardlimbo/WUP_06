...
$H_0$: There is no difference in attitude toward capitol punishment cappun based on race  
$H_A$: There is a difference in attitude toward capitol punishment cappun based on the race.   

# Methods

<!--Decide on your methods:  use "variable analysis" or other appropriate descriptors.  Make sure to choose at least one graphical method and at least one numerical method. Discuss what data manipulations may be needed for example subsetting or other binning procedures and what sort of graphical displays and inferential tools will be used!-->
Because the analysis is categorical we use the categorical method.
...
Whites mostly favor the cappun, and among those that are opposed to the cappun are mostly blacks while the others are mostly equally divided.
...
According to the numerical results about 65% of whites favor cappun and about 35% of whites people oppose it, and about 43% of black people favor cappun while 57% of black people are oppose it.
...
Accoring to all the data the $H_0$ is correct, There is no difference in attitude toward capitol punishment cappun based on race 
